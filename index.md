...
- 🖥️ Managed Linux/Windows Server infrastructure
...
### **Government Digital Services - Zapopan**
**Nov 2021 - Apr 2024** | PHP, Angular, Laravel, Symfony, SQL Server

Key platforms developed:
- 🏛️ [Ventanilla Digital](https://vdigital.zapopan.gob.mx/) - Digital service window for citizens
- 📢 [Sistema de Reportes](https://reporta.zapopan.gob.mx/) - Citizen reporting system
- ♻️ [RETYS](https://retys.zapopan.gob.mx/) - Recycling and environmental services platform

**Impact**: Improved citizen services through digital transformation, reducing in-person visits and processing times.

### **Wedding & Event Planning Platform**
**Freelance Projects** | PHP, JavaScript, MySQL

Custom event planning websites:
- 💒 [Andrea y Alexis](https://eventoespecial.com.mx/andrea-y-alexis/public/)
- 💍 [Nayrumy & Jaime](https://eventoespecial.com.mx/nayrumy-jaime/)

**Features**: RSVP management, photo galleries, event schedules, and guest communication.

### **Monstergram - Social Media Platform**
[Monstergram Demo](https://monstergram-a1e47.web.app/home) | Angular, Firebase

A social media application with real-time features, image sharing, and user interactions.

### **YoRento - Informal Vendors Platform**
